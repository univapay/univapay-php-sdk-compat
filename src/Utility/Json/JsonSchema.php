...
use ReflectionClass;
use Univapay\Compat\Utility\StringUtils;
...
class JsonSchema
{
     ...
     */
    public function with($path, $required = false, $formatter = 'Univapay\Compat\Utility\FunctionalUtils::identity')
    {
    ...
    public function upsert($path, $required = false, $formatter = 'Univapay\Compat\Utility\FunctionalUtils::identity')
    {
